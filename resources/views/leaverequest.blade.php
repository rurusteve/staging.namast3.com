...
<head>
    ...
    <link rel="icon" href="https://my.namast3.com/public/faviconsolis.ico">
    ...
    <link href="{{ asset('js/fontawesome.js') }}" rel="stylesheet">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css"
          integrity="sha384-UHRtZLI+pbxtHCWp1t77Bi1L4ZtiqrqD80Kn4Z8NTSRyMA2Fd33n5dQ8lWUE00s/"
          crossorigin="anonymous">
    ...
    <style>
        ...
        .ui-datepicker.ui-datepicker-multi {
            -webkit-box-shadow: 4px 3px 18px -10px rgba(0, 0, 0, 0.75);
            -moz-box-shadow: 4px 3px 18px -10px rgba(0, 0, 0, 0.75);
            box-shadow: 4px 3px 18px -10px rgba(0, 0, 0, 0.75);
        }
        .filterlink {
    ...
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
        <div class="logo">
            <a style="margin: 0; display: flex; justify-content: center; flex-wrap: wrap" class="navbar-brand"
               href="{{ url('/home') }}">
                <div>
                    <div><img style="margin: 0 5px;" height="50px" src="http://hr.namast3.com/logo.png"></div>
                </div>
            </a>
        </div>
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <i class="material-icons">person</i> Account <span class="caret"></span>
                                </a>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-info">
                                <h4 class="card-title"><b>Pengajuan Cuti</b></h4>
                                ...
                                <form method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="from">{{ __('Dari') }}</label>
                                            <input class="form-control" type="text" id="from" name="from"
                                                   placeholder="mm/dd/yyyy cth: 12/31/2019" required/>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="to">{{ __('sampai') }}</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jeniscuti" required>
                                            <option value="{{ old('jeniscuti') }}">
                                                Pilih jenis cuti
                                            </option>
                                            <option value="1"> {{ucwords(strtolower('CUTI TAHUNAN DAN WISATA'))}}</option>
                                            <option value="2"> {{ucwords(strtolower('CUTI PERKAWINAN, KELAHIRAN DAN MENIKAHKAN ANAK**'))}}</option>
                                            <option value="3"> {{ucwords(strtolower('CUTI KEGUGURAN DAN KEMATIAN**'))}}</option>
                                            <option value="4"> {{ucwords(strtolower('CUTI FORCE MAJEUR'))}}</option>
                                            <option value="5"> {{ucwords(strtolower('IJIN RESMI (KTP, SIM, STNK, PASPOR, DAN SURAT NIKAH)**'))}}</option>
                                            <option value="6"> {{ucwords(strtolower('IJIN SAKIT'))}}</option>
                                            <option value="7"> {{ucwords(strtolower('IJIN SAKIT DENGAN SURAT DOKTER*'))}}</option>
                                            <option value="8"> {{ucwords(strtolower('CUTI TIDAK DIBAYAR (MANGKIR/TIDAK ADA JATAH)'))}}</option>
                                            {{--<option value="9"> {{ucwords(strtolower('JUMLAH CUTI YANG DIAMBIL'))}}</option>--}}
                                        </select>
                                        <p style="font-size: 0.8em;">Note: ** bukti wajib dilampirkan, * validasi dan
                                            verifikasi</p>
                                        {{--<input type="text" class="form-control" id="jeniscuti" name="jeniscuti" placeholder="">--}}
                                    </div>
                                    ...
                                    <div class="file-upload">
                                        <div class="file-select">
                                            ...
                                            <input type="file" name="penugasan" id="penugasan">
                                            <span class="help-block text-danger">{{ $errors->first('penugasan') }}</span>
                                        </div>
                                    </div>
                                    <a href="http://solis.rurusteve.com/templatepenugasan.xlsx"
                                       style="font-size: 0.8em;">Download Template Penugasan</a>
...
* Copyright 2014 jQuery Foundation and other contributors; Licensed MIT */
                                ...
                                (function (e) {
                                    ...
                                    e(document).mouseup(function () {
                                        ...
                                        e.ui = e.ui || {};
                                        var n, a, o = Math.max, r = Math.abs, h = Math.round, l = /left|center|right/,
                                            u = /top|center|bottom/, d = /[\+\-]\d+(\.[\d]+)?%?/, c = /^\w+/, p = /%$/,
                                            f = e.fn.position;
                                        e.position = {
                                            ...
                                            var p, m, g, v, y, b, _ = e(n.of), x = e.position.getWithinInfo(n.within),
                                                w = e.position.getScrollInfo(x), k = (n.collision || "flip").split(" "),
                                                T = {};
                                            ...
                                            fit: {
                                                left: function (e, t) {
                                                    var i, s = t.within, n = s.isWindow ? s.scrollLeft : s.offset.left,
                                                        a = s.width, r = e.left - t.collisionPosition.marginLeft,
                                                        h = n - r, l = r + t.collisionWidth - a - n;
                                                    t.collisionWidth > a ? h > 0 && 0 >= l ? (i = e.left + h + t.collisionWidth - a - n, e.left += h - i) : e.left = l > 0 && 0 >= h ? n : h > l ? n + a - t.collisionWidth : n : h > 0 ? e.left += h : l > 0 ? e.left -= l : e.left = o(e.left - r, e.left)
                                                }, top: function (e, t) {
                                                    var i, s = t.within, n = s.isWindow ? s.scrollTop : s.offset.top,
                                                        a = t.within.height, r = e.top - t.collisionPosition.marginTop,
                                                        h = n - r, l = r + t.collisionHeight - a - n;
                                                    t.collisionHeight > a ? h > 0 && 0 >= l ? (i = e.top + h + t.collisionHeight - a - n, e.top += h - i) : e.top = l > 0 && 0 >= h ? n : h > l ? n + a - t.collisionHeight : n : h > 0 ? e.top += h : l > 0 ? e.top -= l : e.top = o(e.top - r, e.top)
                                                }
                                            }, flip: {
                                                left: function (e, t) {
                                                    var i, s, n = t.within, a = n.offset.left + n.scrollLeft,
                                                        o = n.width, h = n.isWindow ? n.scrollLeft : n.offset.left,
                                                    ...
                                                    var i, s, n = t.within, a = n.offset.top + n.scrollTop,
                                                        o = n.height, h = n.isWindow ? n.scrollTop : n.offset.top,
                                        ...
                                        _eventHandler: function (t) {
                                            var i = this.options, s = this.active, n = e(t.currentTarget),
                                                a = n[0] === s[0], o = a && i.collapsible, r = o ? e() : n.next(),
                                                h = s.next(),
                                    ...
                                    e.widget("ui.button", {
                                        ...
                                        refresh: function () {
                                            var t = "rtl" === this.element.css("direction"),
                                                i = this.element.find(this.options.items), s = i.filter(":ui-button");
                                    ...
                                    e.extend(n.prototype, {
                                        ...
                                        parseDate: function (t, i, s) {
                                            ...
                                            var n, a, o, r, h = 0,
                                                ...
                                                f = (s ? s.monthNames : null) || this._defaults.monthNames, m = -1,
                                                g = -1, v = -1, y = -1, b = !1, _ = function (e) {
                                                    var i = t.length > n + 1 && t.charAt(n + 1) === e;
                                                    return i && n++, i
                                                }, x = function (e) {
                                                    var t = _(e),
                                                        s = "@" === e ? 14 : "!" === e ? 20 : "y" === e && t ? 4 : "o" === e ? 3 : 2,
                                                        n = "y" === e ? s : 1, a = RegExp("^\\d{" + n + "," + s + "}"),
                                        ...
                                        _generateHTML: function (e) {
                                            var t, i, s, n, a, o, r, h, l, u, d, c, p, f, m, g, v, y, b, _, x, w, k, T,
                                                D, S, M, C, N, A, P, I, z, H, F, E, O, j, W, L = new Date,
                                                ...
                                                X = this._getMinMaxDate(e, "min"), $ = this._getMinMaxDate(e, "max"),
                                                Z = e.drawMonth - V, et = e.drawYear;
                                        ...
                                        _generateMonthYearHeader: function (e, t, i, s, n, a, o, r) {
                                            var h, l, u, d, c, p, f, m, g = this._get(e, "changeMonth"),
                                                v = this._get(e, "changeYear"), y = this._get(e, "showMonthAfterYear"),
                                        ...
                                        _generatePosition: function (e, t) {
                                            var i, s, n, a, o = this.options,
                                                r = this._isRootNode(this.scrollParent[0]), h = e.pageX, l = e.pageY;
                                        ...
                                        start: function (t, i, s) {
                                            ...
                                            var n, a, o, r, h, l, u, d, c, p, f = s.options, m = f.snapTolerance,
                                                g = i.offset.left, v = g + s.helperProportions.width, y = i.offset.top,
                                        ...
                                        start: function () {
                                            var t, i, s, n, a, o, r, h = e(this).resizable("instance"), l = h.options,
                                                u = h.element, d = l.containment,
                                            ...
                                            var i, s, n, a, o = e(this).resizable("instance"), r = o.options,
                                                h = o.containerOffset, l = o.position, u = o._aspectRatio || t.shiftKey,
                                                d = {top: 0, left: 0}, c = o.containerElement, p = !0;
                                            ...
                                            var t = e(this).resizable("instance"), i = t.options, s = t.containerOffset,
                                                n = t.containerPosition, a = t.containerElement, o = e(t.helper),
                                                r = o.offset(), h = o.outerWidth() - t.sizeDiff.width,
                                        ...
                                        start: function () {
                                            ...
                                            var s = e(this).resizable("instance"), n = s.options, a = s.originalSize,
                                                o = s.originalPosition, r = {
                                                    ...
                                                    e(t).each(function () {
                                                        var t = e(this), n = e(this).data("ui-resizable-alsoresize"),
                                                            a = {},
                                        ...
                                        resize: function () {
                                            var t, i = e(this).resizable("instance"), s = i.options, n = i.size,
                                                ...
                                                g = s.maxHeight && f > s.maxHeight, v = s.minWidth && s.minWidth > p,
                                        ...
                                        return function (t, i, s, n) {
                                            ...
                                            var a = (t.positionAbs || t.position.absolute).left + t.margins.left,
                                                ...
                                                r = a + t.helperProportions.width, h = o + t.helperProportions.height,
                                                l = i.offset.left, u = i.offset.top, d = l + i.proportions().width,
                                    ...
                                    e.effects = {effect: {}}, function (e, t) {
                                        ...
                                        p.style.cssText = "background-color:rgba(1,1,1,.5)", c.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(u, function (e, t) {
                                            ...
                                            var t, i, s = e[0] / 255, n = e[1] / 255, a = e[2] / 255, o = e[3],
                                                r = Math.max(s, n, a), h = Math.min(s, n, a), l = r - h, u = r + h,
                                                d = .5 * u;
                                        ...
                                        var s, n, a, o = e(this),
                                            ...
                                            u = "show" === h, d = t.direction || "up", c = t.distance, p = t.times || 5,
                                            f = 2 * p + (u || l ? 1 : 0), m = t.duration / f, g = t.easing,
                                        ...
                                        var s, n = e(this),
                                            ...
                                            h = t.direction || "left", l = "up" === h || "down" === h ? "top" : "left",
                                            u = "up" === h || "left" === h ? "pos" : "neg", d = {opacity: r ? 1 : 0};
                                        ...
                                        var a, o, r, h, l, u, d = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, c = d,
                                            p = e(this), f = e.effects.setMode(p, t.mode || "hide"), m = "show" === f,
                                            g = p.show().css("visibility", "hidden").offset(),
                                            v = Math.ceil(p.outerWidth() / c), y = Math.ceil(p.outerHeight() / d),
                                            b = [];
                                        ...
                                        var s, n, a = e(this),
                                            ...
                                            f = p ? ["width", "height"] : ["height", "width"], m = t.duration / 2,
                                            g = {}, v = {};
                                        ...
                                        var s = e(this), n = e.effects.setMode(s, t.mode || "hide"), a = "hide" === n,
                                            o = parseInt(t.percent, 10) || 150, r = o / 100, h = {
                                                height: s.height(),
                                                width: s.width(),
                                                outerHeight: s.outerHeight(),
                                                outerWidth: s.outerWidth()
                                        ...
                                        var s, n = e(this),
                                            ...
                                            o = e.effects.setMode(n, t.mode || "effect"), r = t.direction || "left",
                                            h = t.distance || 20, l = t.times || 3, u = 2 * l + 1,
                                            d = Math.round(t.duration / u),
                                            c = "up" === r || "down" === r ? "top" : "left",
                                            p = "up" === r || "left" === r, f = {}, m = {}, g = {}, v = n.queue(),
                                            y = v.length;
                                        ...
                                        var s = e(this), n = e(t.to), a = "fixed" === n.css("position"), o = e("body"),
                                            r = a ? o.scrollTop() : 0, h = a ? o.scrollLeft() : 0, l = n.offset(), u = {
                                                top: l.top - r,
                                                left: l.left - h,
                                        ...
                                        _mouseDrag: function (t) {
                                            if (this.dragged = !0, !this.options.disabled) {
                                                var i, s = this, n = this.options, a = this.opos[0], o = this.opos[1],
                                                    r = t.pageX, h = t.pageY;
                                        ...
                                        _mouseStop: function (t, i) {
                                            if (t) {
                                                if (e.ui.ddmanager && !this.options.dropBehaviour && e.ui.ddmanager.drop(this, t), this.options.revert) {
                                                    var s = this, n = this.placeholder.offset(), a = this.options.axis,
                                                        o = {};
                                        ...
                                        _processTabs: function () {
                                            ...
                                            this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist").delegate("> li", "mousedown" + this.eventNamespace, function (t) {
                                                ...
                                                var n, a, o, r = e(s).uniqueId().attr("id"), h = e(s).closest("li"),
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div style="font-size: 8px" class="copyright float-right">
                    &copy; rurusteve
                </div>
            </div>
        </footer>
