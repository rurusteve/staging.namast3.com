                        ...
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                ...
                                <select style="background: none; height: calc(2.25rem + 2px); width: 100%; font-size: 1rem" id="clientselect" class="chosen form-control{{ $errors->has('clientselect') ? ' is-invalid' : '' }}" name="clientselect">
                                    ...
                                    <option data-location="{{ $client->location }}" data-type="{{ $client->engagementtype }}" data-period="{{ Carbon\Carbon::parse($client->engagementperiod)->format('Y') }}" value="{{$client->client_id}}">ID:{{$client->client_id}} {{$client->clientname}}
                                        , {{$client->clientcode}}
