            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        Declining Leave Request by {{ucwords(strtolower($employees->nama))}}
                        , {{ date('d M y', strtotime($leaverequestdetails->tanggalmulaicuti)) }} -
                        {{ date('d M y', strtotime($leaverequestdetails->tanggalakhircuti)) }}
                    </div>
                    <div class="card-body">
                        <form action="{{ URL::to('/adminrequestleavelist/declined/'.$nip.'/'.$id) }}" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="">
                                ...
                                <div class="col-md-6">
                                    <div class="alert-heading">Decline Message</div>
