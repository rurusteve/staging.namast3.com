...
class IndTimeReportExport implements FromCollection, WithHeadings, WithEvents, ShouldAutoSize, WithColumnFormatting
{
    /**
    ...
    public function __construct(int $period = null, $request)
    {
        $this->period = $period;
        ...
        $this->user = MasterEmployee::where('nip', $request->employee)->first();
    }
    ...
    public function collection()
    {
        ...
        foreach ($timereports as $timereport)
        {
            ...
            $selectedData = [
                ...
                'clientcode'    => $client->id.'. '.$client->clientname,
                'regularhour'   => $timereport->normalhours,
                'overtimehour'  => $timereport->overtimes,
                'starttime'     => $timereport->starttime,
                'finishtime'    => $timereport->finishtime,
                'description'   => $timereport->description,
                'type'          => $type,
                'inchargeapproval'    => $timereport->approved_by_incharge,
                'hrapproval'    => $timereport->approved_by_hr,
                'partnerapproval'    => $timereport->approved_by_partner,
